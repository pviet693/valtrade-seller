...
const AddNewProduct = (props) => {
    ...
    const createProduct = async (e) => {
        ...
        try {
            ...
            formData.append("information", JSON.stringify(productForm.value))
                        ...
                        <div>
                            ...
                            <div className="form-group row">
                                ...
                                <div className="col-sm-6 d-flex flex-row flex-wrap">
                                    ...
                                    <div className="d-flex flex-column add-image-container mb-4">
                                        <div className="add-image-box">
                                            <div className="add-image-circle">
                                                {
                                                    urlImages.image2 === "" &&
                                                    <>
                                                        <div className={classNames("add-image-circle")}>
                                            ...
                                            attributes.map(x => {
                                                return (
                                                    <FieldControl
                                                        ...
                                                        render={({ handler, touched, hasError, dirty }) => (
                                                            <div className="form-group row align-items-center d-flex">
                                                                <label htmlFor={x.key} className="col-sm-2 col-form-label">{`${x.name}:`}</label>
                                                                <div className="col-sm-6">
                                                                    <input 
                                                                        className={classNames("form-control", { 'is-invalid': hasError('required') && showError })}
                                                                        placeholder={`${x.name}`} type="text" name={x.key} id={x.key} {...handler()} />
                                                                    {
